...
export default function EditModeIndicator({ isEditMode }: EditModeIndicatorProps) {
  ...
  return (
    <div className="fixed top-6 right-6 glass-indicator bg-gradient-to-r from-blue-500/90 to-purple-500/90 backdrop-blur-xl text-white px-6 py-3 rounded-full shadow-glass-lg z-50 flex items-center gap-3 animate-slideDown border border-white/30">
