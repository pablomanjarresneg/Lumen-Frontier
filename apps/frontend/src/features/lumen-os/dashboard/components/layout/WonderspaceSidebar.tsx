    ...
    <div className="fixed left-0 top-0 bottom-0 w-16 flex flex-col items-center py-4 z-50 backdrop-blur-xl bg-black/40 border-r border-white/20">
      ...
      <div className="mt-auto flex flex-col gap-2">
        ...
        <button
          ...
          className={`transition-colors p-2 ${isEditMode ? 'text-white' : 'text-white/50 hover:text-white'}`}
          title="Edit Mode"
        >
      ...
      <div className="mt-4">
        <button className="text-white/50 hover:text-white transition-colors p-2" title="Community">
